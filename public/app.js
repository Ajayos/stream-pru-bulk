...
class StreamingApp {
  ...
  cacheElements() {
    this.elements = {
      ...
      overlay: document.getElementById("clearMarkOverlay"),
      input: document.getElementById("clearMarkInput"),
      cancelBtn: document.getElementById("clearMarkCancel"),
      submitBtn: document.getElementById("clearMarkSubmit"),
    };
  }
  ...
  setupEventListeners() {
    ...
    this.elements.cancelBtn.addEventListener("click", () =>
      this.handleCancelOnInput()
    );

    this.elements.clearMarkBtn.addEventListener("click", () => {
